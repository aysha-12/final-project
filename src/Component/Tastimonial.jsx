    ...
    return (
        <div>
            <div className="text-center md:mt-15 mt-5 ">
                <h1 className="text-3xl md:text-4xl font-bold text-[#10305e]">What Our Customers Say?</h1>
                <p className="text-sm md:text-base text-gray-600 mt-4">Join thousand of successful businessman  who transformed their careers with us</p>
                <div className="flex flex-wrap justify-center gap-5 mt-16 text-left">
                    <div className="w-80 flex flex-col items-start border border-gray-200 p-5 rounded-lg bg-white shadow-[0px_0px_10px_0px] shadow-black">
