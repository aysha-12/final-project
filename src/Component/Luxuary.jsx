...
const Luxuary = () => {
    ...
    useEffect(() => {
        ...
        fetch('https://e-commerce-iota-ten-86.vercel.app/table')
            .then(res => res.json())
    ...
    return (
        <div className=' mt-10 px-5 md:px-8 lg:px-20'>
            <h1 className='text-3xl md:text-4xl  font-bold text-center px-3 md:px-16 lg:px-24 xl:px-32  text-[#183153]  leading-tight md:leading-14 '>luxury second-hand products</h1>
            <p className='text-xl  font-bold text-center px-3 md:px-16 lg:px-24 xl:px-32  text-[#183153]  leading-tight md:leading-10 '>Lorem ipsum dolor sit amet, consectetur adipisicing.</p>
                        ...
                        <div className="card bg-base-100 shadow-2xl">
                            <figure className="px-2 pt-3">
                                <img
                                    src={data?.img}
                                    alt="beds"
                                    className="rounded-xl h-60 md:h-60 w-full" />
                            </figure>
                           ...
                           <div className='flex items-center gap-3'> <div class="relative">
                                ...
                                <p class="text-sm text-gray-500">SWE 2 @ Google</p></div></div>
                            ...
                            <div className="card-body text-sm items-center text-center">
                               ...
                               <div className='flex items-center gap-3'> <div class="relative">
                                    <img class="h-10 w-10 rounded-full"
                                        ...
                                        alt="userImage1" />
                                   {
                                    data?.isActive? <div className="absolute bottom-2 right-0 h-3 w-3 rounded-full bg-green-500"></div>: <div class="absolute bottom-2 right-0 h-3 w-3 rounded-full bg-gray-500"></div>
                                   }
                                </div> <div><span className='font-black text-[#26589e]'>{data.sellerName}</span>
